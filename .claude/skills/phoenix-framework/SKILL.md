...
description: "Use this skill when working with Phoenix Framework. Consult this when working with the web layer, controllers, views, LiveViews, templates, routing, etc."
metadata:
